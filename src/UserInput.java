...
public class UserInput {
    ...
    // Please implement the obtainHeight() method to obtain user input for the height in Inches or Meters, based on the entered BMI system
    // -------------------------------------------------
    ...
    public double obtainHeight(String bmiSystem) {
        ...
        while (isInvalidInput) {
            ...
            // Check if the user has entered a valid value (double value) for height
            // -------------------------------------------------
